...
namespace desafio
{
	...
	void MainMenuState::Init()
	{
		...
		this->_playButton.setPosition((SCREEN_WIDTH / 2) - (this->_playButton.getGlobalBounds().width / 2), (SCREEN_HEIGHT / 1.5f) - (this->_playButton.getGlobalBounds().height / 1.5f));
		this->_playButtonOuter.setPosition((SCREEN_WIDTH / 2) - (this->_playButtonOuter.getGlobalBounds().width / 2), (SCREEN_HEIGHT / 1.5f) - (this->_playButtonOuter.getGlobalBounds().height / 1.5f));
